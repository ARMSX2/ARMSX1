...
// This app is ARMSX1; ARMSX2 is the PS2 sibling repo.
private const val GithubUrl = "https://github.com/ARMSX2/ARMSX1"
...
private fun DrawerContent(selected: AppRoute, onNavigate: (AppRoute) -> Unit, onDismiss: () -> Unit) {
    ...
    val primary = listOf(
        ...
        // Boot straight into the PlayStation system BIOS with no disc — distinct from "BIOS
        // Location" below, which only points the emulator at your BIOS file.
    ...
    val managers = listOf(
        ...
        DrawerItem("cheats.title", "✦", AppRoute.PatchManager),
    )
