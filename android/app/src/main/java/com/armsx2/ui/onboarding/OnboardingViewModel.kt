...
class OnboardingViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun importBios(uri: Uri) {
        ...
        state.value = if (imported != null) {
            ...
            state.value.copy(busy = false, error = "The selected file is not a valid PlayStation BIOS.")
        }
    }
    ...
    fun importBiosFolder(treeUri: Uri) {
        ...
        viewModelScope.launch {
            ...
            state.value = if (chosen != null) {
                ...
                state.value.copy(busy = false, error = "No PlayStation BIOS files were found in that folder.")
            }
        }
    }
