...
internal val SETTINGS_SEARCH_INDEX: List<SettingsSearchEntry> = listOf(
    ...
    SettingsSearchEntry("memcard.title", true, SettingsCategory.MemoryCards),
    SettingsSearchEntry("memcard.slot1", true, SettingsCategory.MemoryCards),
    SettingsSearchEntry("memcard.slot2", true, SettingsCategory.MemoryCards),
