...
private const val RepositoryUrl = "https://github.com/ARMSX2/ARMSX1"
private const val RepositorySlug = "ARMSX2/ARMSX1"
        ...
        Column(Modifier.fillMaxSize().verticalScroll(rememberScrollState())) {
            ...
            BoxWithConstraints(Modifier.fillMaxWidth()) {
                ...
                Column(
                    ...
                    // Single project card: the upstream-PCSX2 card was dropped with the
                    // PS2 branding — ARMSX1 does not ship that core, so pointing users at
                    // it was misleading.
                    ProjectCard(
