 ...
 *
 * Cache with a TTL, and on a total network failure fall back to
 * whatever is on disk rather than showing an error — stale notes still beat a blank page.
 */
object News {
    private const val TAG = "News"
    // ARMSX1 releases — this app is ARMSX1; the ARMSX2 repo is the PS2 sibling and its
    // release notes are not about this build.
