...
CASES = {
    ...
    "gpu-transfer": (["make", "test-gpu-transfer"], 120.0),
    "gpu-fast": (["make", "test-gpu-fast"], 120.0),
    "gpu-bios": (["make", "test-gpu-bios"], 180.0),
    ...
    "audio-stretch": (["make", "test-audio-stretch"], 60.0),
    "cdrom-xa-audio": (["make", "test-cdrom-xa-audio"], 60.0),
    "mdec-bounds": (["make", "test-mdec-bounds"], 180.0),
    "spu-width": (["make", "test-spu-width"], 180.0),
    "mcard-diverge": (["make", "test-mcard-diverge"], 180.0),
    "mcard-protocol": (["make", "test-mcard-protocol"], 180.0),
    "state-snapshots": (["make", "test-state-snapshots"], 180.0),
    "runahead": (["make", "test-runahead"], 600.0),
    "cue-parse": (["make", "test-cue-parse"], 60.0),
    "host-run-gate": (["make", "test-host-run-gate"], 60.0),
    "sda-input": (["make", "test-sda-input"], 180.0),
    "dma-alignment": (["make", "test-dma-alignment"], 180.0),
    "diagnostics": (["make", "test-diagnostics"], 60.0),
